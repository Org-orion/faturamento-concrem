...
export function rowToOrder(row: Row, defaultClientId: string): Order {
  ...
  return {
    ...
    clientCep: pickString(row, ['cliente_cep', 'cep_cliente', 'clientCep']) || undefined,
    clientEndereco: pickString(row, ['cliente_endereco', 'endereco_cliente', 'clientEndereco']) || undefined,
    clientBairro: pickString(row, ['cliente_bairro', 'bairro_cliente', 'clientBairro']) || undefined,
